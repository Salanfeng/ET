...
enum class QuantizeType : int8_t {
  ...
  BLOCKWISE_EXPANSION = 4,
  UNDEFINED = 5,
  MIN = SCALE_OFFSET,
  MAX = UNDEFINED
};

inline const QuantizeType (&EnumValuesQuantizeType())[6] {
  static const QuantizeType values[] = {
    ...
    QuantizeType::BLOCKWISE_EXPANSION,
...
enum class BlockScaleStorageType : int8_t {
  BITWIDTH_SCALE_STORAGE_8 = 0,
  BITWIDTH_SCALE_STORAGE_16 = 1,
  UNDEFINED = 2,
  MIN = BITWIDTH_SCALE_STORAGE_8,
  MAX = UNDEFINED
};

inline const BlockScaleStorageType (&EnumValuesBlockScaleStorageType())[3] {
  static const BlockScaleStorageType values[] = {
    BlockScaleStorageType::BITWIDTH_SCALE_STORAGE_8,
    BlockScaleStorageType::BITWIDTH_SCALE_STORAGE_16,
    BlockScaleStorageType::UNDEFINED
  };
  return values;
}

inline const char * const *EnumNamesBlockScaleStorageType() {
  static const char * const names[4] = {
    "BITWIDTH_SCALE_STORAGE_8",
...
inline const char *EnumNameBlockScaleStorageType(BlockScaleStorageType e) {
  if (::flatbuffers::IsOutRange(e, BlockScaleStorageType::BITWIDTH_SCALE_STORAGE_8, BlockScaleStorageType::UNDEFINED)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesBlockScaleStorageType()[index];
}
...
struct QuantizeParam FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_OFFSETS = 14,
    VT_DATA = 16,
    VT_NUM_BLOCKS_PER_AXIS = 18,
    VT_BLOCK_SCALE_STORAGE_TYPE = 20,
    VT_BLOCK_SCALE = 22
  };
  ...
  uint32_t num_blocks_per_axis() const {
    return GetField<uint32_t>(VT_NUM_BLOCKS_PER_AXIS, 0);
  }
  qcir::BlockScaleStorageType block_scale_storage_type() const {
    return static_cast<qcir::BlockScaleStorageType>(GetField<int8_t>(VT_BLOCK_SCALE_STORAGE_TYPE, 0));
  }
  const ::flatbuffers::Vector<uint8_t> *block_scale() const {
    return GetPointer<const ::flatbuffers::Vector<uint8_t> *>(VT_BLOCK_SCALE);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint32_t>(verifier, VT_NUM_BLOCKS_PER_AXIS, 4) &&
           VerifyField<int8_t>(verifier, VT_BLOCK_SCALE_STORAGE_TYPE, 1) &&
           VerifyOffset(verifier, VT_BLOCK_SCALE) &&
           verifier.VerifyVector(block_scale()) &&
           verifier.EndTable();
  }
};
...
struct QuantizeParamBuilder {
  ...
  void add_num_blocks_per_axis(uint32_t num_blocks_per_axis) {
    fbb_.AddElement<uint32_t>(QuantizeParam::VT_NUM_BLOCKS_PER_AXIS, num_blocks_per_axis, 0);
  }
  void add_block_scale_storage_type(qcir::BlockScaleStorageType block_scale_storage_type) {
    fbb_.AddElement<int8_t>(QuantizeParam::VT_BLOCK_SCALE_STORAGE_TYPE, static_cast<int8_t>(block_scale_storage_type), 0);
  }
  void add_block_scale(::flatbuffers::Offset<::flatbuffers::Vector<uint8_t>> block_scale) {
    fbb_.AddOffset(QuantizeParam::VT_BLOCK_SCALE, block_scale);
  }
...
inline ::flatbuffers::Offset<QuantizeParam> CreateQuantizeParam(
    ...
    uint32_t num_blocks_per_axis = 0,
    qcir::BlockScaleStorageType block_scale_storage_type = qcir::BlockScaleStorageType::BITWIDTH_SCALE_STORAGE_8,
    ::flatbuffers::Offset<::flatbuffers::Vector<uint8_t>> block_scale = 0) {
  QuantizeParamBuilder builder_(_fbb);
  builder_.add_block_scale(block_scale);
  builder_.add_num_blocks_per_axis(num_blocks_per_axis);
  builder_.add_data(data);
  builder_.add_offsets(offsets);
  builder_.add_scales(scales);
  builder_.add_axis(axis);
  builder_.add_bitwidth(bitwidth);
  builder_.add_block_scale_storage_type(block_scale_storage_type);
...
inline ::flatbuffers::Offset<QuantizeParam> CreateQuantizeParamDirect(
    ...
    uint32_t num_blocks_per_axis = 0,
    qcir::BlockScaleStorageType block_scale_storage_type = qcir::BlockScaleStorageType::BITWIDTH_SCALE_STORAGE_8,
    const std::vector<uint8_t> *block_scale = nullptr) {
  ...
  auto block_scale__ = block_scale ? _fbb.CreateVector<uint8_t>(*block_scale) : 0;
