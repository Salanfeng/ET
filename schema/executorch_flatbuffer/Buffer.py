...
def BufferAddStorage(builder, storage):
...
def BufferStartStorageVector(builder, numElems):
    return builder.StartVector(1, numElems, 1)

def StartStorageVector(builder, numElems):
